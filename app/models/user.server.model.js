...
///SysAdmin Role..
Role.findOneAndUpdate({name:'SysAdmin'}, {name: 'SysAdmin', _actions:['create_role', 'edit_role', 'delete_role', 'list_roles', 'view_role', 'create_user', 'edit_user', 'delete_user', 'list_users', 'view_user', 'create_patient', 'edit_patient', 'delete_patient', 'list_patients', 'view_patient']}, {upsert:true}, function(err, role){
    if(err){
