    ...
    return {
      ...
      link: function postLink($scope, element) {
        ...
        var isStreaming = false;//,
            //width = null,//element.videoWidth,//= 320,
            //height = null;//element.videoHeight ;//= 0;
        ...
        videoElem.addEventListener('canplay', function() {
          if (!isStreaming) {
            ...
            videoElem.setAttribute('width', videoElem.videoWidth);
            videoElem.setAttribute('height', videoElem.videoHeight);
            isStreaming = true;
